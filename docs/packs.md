...
**Design:** [`hld/design-plugin-packs.md`](../hld/design-plugin-packs.md)  
**Kernel workflow:** [`docs/agents.md`](agents.md)
...
```bash
python scripts/smoke_packs.py    # expect PACKS SMOKE OK
pytest packages/trestle-packs/tests/ -q
```

Docker must be installed on the host for `docker_stack` and `integration_pipeline`.
