...
from trestle_packs.pytest.runner import PytestResult, PytestSpec, run_pytest
...
def pytest_run(
    ...
    ctx.log(f"pytest: collected={result.collected} passed={result.passed} failed={result.failed}")
