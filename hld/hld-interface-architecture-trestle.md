...
- Operational (agent MCP): [Agent console MCP playbook](../docs/agent-console-mcp.md); [console access scope plan](plan-daytona-clean-room-scope.md) (Phase C complete)
